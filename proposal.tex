...
\noindent \cite{joint_planning_2026} addresses joint planning of distribution systems and ev charging infrastructure using a gis-based spatial anal. This work addresses dissertation gaps: G1.
...
\noindent \cite{hybrid_optimization_2025} addresses a density-based spatial clustering and linear programming method for EV charging stati. This work addresses dissertation gaps: G1.
...
\noindent \cite{a_two-stage_2025} addresses a two-stage optimization framework for ev charging station planning considering investment cost and . This work addresses dissertation gaps: G1.
...
\noindent \cite{data-driven_ev_2025} addresses data-driven ev charging infrastructure with uncertainty based on a spatial--temporal flow-driven (stf. This work addresses dissertation gaps: G1, G4.



\noindent \cite{data-driven_optimization_2025} addresses the critical challenge of optimizing EVCS placement through a novel data-driven methodology employing causal discovery techniques. While traditional approaches prioritize economic factors or power grid constraints, they often neglect empirical charging patterns that ultimately determine station utilization. We analyze extensive charging data from Palo Alto and Boulder (337,344 events across 100 stations) to uncover latent relationships between station characteristics and utilization. This work addresses dissertation gaps: G1.



\noindent \cite{electric_vehicle_2025} addresses EV charging planning: a complex systems perspective. This work addresses dissertation gaps: G1, G3.



\noindent \cite{explainable_and_2025} addresses explainable and context-aware graph neural networks for dynamic EV route optimization . This work addresses dissertation gaps: G1.



\noindent \cite{planning_future_2025} addresses fairness-oriented charging station location optimization driven by deep reinforcement learning. This work addresses dissertation gaps: G1, G3.



\noindent \cite{hybrid_optimization_2025} addresses hybrid optimization of ev charging station placement and pricing using bender?s decomposition and ns. This work addresses dissertation gaps: G1.
...
\noindent \cite{optimizing_electric_2025} addresses optimizing electric bus charging station locations: an integrated land-use and transportation approa. This work addresses dissertation gaps: G1.
...
\noindent \cite{analyzing_locational_2025} addresses predicting optimal placement of EV charge stations using machine learning: a case stud. This work addresses dissertation gaps: G1.
...
\noindent \cite{a_particle_2024} addresses a particle swarm optimizer-based optimization approach for locating EVs charging stati. This work addresses dissertation gaps: G1.
...
\noindent \cite{allocate_electric_2024} addresses a two-layer planning method for location and capacity determination of public EV charg. This work addresses dissertation gaps: G1.



\noindent \cite{a_multi-objective_2024} addresses advancing urban EVCSs: ai-driven day-ahead optimization of pricing and . This work addresses dissertation gaps: G1.
